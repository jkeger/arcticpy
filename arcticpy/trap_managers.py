...
class AllTrapManager(UserList):
    ...
    def restore(self):
        ...
        # Could also have done this instead of remembering how many are in save,
        # but it makes restoring a bit slower (and restoring is done more
        # frequently than saving)
