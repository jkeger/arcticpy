...
surface_trap = ac.TrapNonUniformHeightDistribution(density=surface_trap_density, lifetime=0.01, 
    electron_fractional_height_min=blooming_height, electron_fractional_height_max=blooming_height)
...
plt.scatter(pixels, (image_cti-background)[:, 0], c="k", marker=".", label="Express$=0$")
